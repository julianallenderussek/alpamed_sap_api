...
echo Se cargo ORDN Recepcion Created Succesfully) ELSE (echo No File found - C:\Users\U002\Desktop\alpamed_sap_api\files\reception\material\create\ordr.txt)
